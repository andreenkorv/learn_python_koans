...
def test_can_sum_up():
    ...
    assert 1 + 1 == 2  # Вставьте вместо __ такое значение, чтобы оно
    # совпадало с результатом выполнения 1 + 1
...
def test_can_divide():
    """
        ...
        Обратите внимание, что в результате деления целых чисел
        можно получить вещественное число.
    """
