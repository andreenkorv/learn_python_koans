...
def test_create_list_with_literal():
    ...
    my_list = ['Hello', 'world']
    assert my_list == ['Hello', 'world']  # попробуйте ввести такие варианты:
...
def test_create_list_with_constructor():
    """
        ...
        your_list = list('Learn') и получаем список
        your_list = ['L', 'e', 'a', 'r', 'n']
    """
    ...
    # попробуйте ввести такие варианты:
    # dict, list, set
...
def test_add_item_to_list():
    """
        ...
        Новые элементы становятся в конец списка
        your_list = ['Moscow', 'Kiev', 'London']
    """
