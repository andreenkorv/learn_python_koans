...
def test_can_assign_to_variable():
    """
        ...
        При использовании переменной в выражении,
        Python подставит значение переменной.
    """
    a = 12
...
def test_variables_names_are_case_sensitive():
    """
        ...
        "a" и "A" – две разные переменные.

        Несмотря на возможность называть переменные заглавными буквами,
        в Python
...
def test_variables_names_can_have_underscore():
    """
        ...
        Это используется,
        когда в названии переменной несколько слов и нужно отделить
         одно от другого.
    """
