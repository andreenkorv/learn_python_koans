...
def test_create():
    """
        ...
        Создать множество можно через функцию set(),
        передав в неё любую последовательность,
        или заключив последовательность в фиурные скобки {1, 2, 3}.

        P.S пустое множество невозможно создать как {},
        так-как синтаксис совпадёт с созданием словаря.
    """
...
def test_words_in_set():
    ...
    """
    my_set = {True, 'set', 2}  # попробуйте такие варианты:
    # {True, 'set', 2}, {'cow', 'fox', 'cat'}
    assert isinstance(my_set, set)
